	...
	render(){
			return <div className="col-sm-12">
				...
				<div className="form-group">
					...
					<input type="checkbox" onChange= { (e) => this.exclude_ladder_changed(e) } checked={this.state.exclude_ladder} />exclude first column(ladder)
				</div>
				<div className="form-group">
				...
				<RestrictGraph {...this.props} {...this.state} width="500" height="500" row_padding="50" padding="30" />
			</div>
	}
}
