...
requirejs([], function () {
	var CodonTranslation = function (_React$Component) {
		...
		function CodonTranslation(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(CodonTranslation).call(this, props));
		}
	...
	ReactDOM.render(React.createElement(CodonTranslation, null), mountingPoint);
});